...
Clean + fixed structure (production ready)
"""
...
class AdminService:
    ...
    def get_dashboard_stats() -> dict:
        users = [_u.to_dict() for _u in _db().collection("users").stream()]
        payments = [
            p.to_dict()
            for p in _db().collection("payments")
